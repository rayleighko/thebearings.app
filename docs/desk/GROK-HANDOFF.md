...
**2026-08-20 — 4편 실행.** SKU `arm-nb-f80`. 훅: 모니터 받침대(잘못된 처방). 스탠드·키보드·마우스·식품 히어로 금지.
...
지금 그록: `content/desk/uploads/04-arm-nb-f80/script.json` 잠금대로 스톡+렌더. 대본 문구를 바꾸지 말 것. 1–3편 클립 재사용 금지. 스탠드 히어로 컷 금지.
